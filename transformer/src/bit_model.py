...
class SelfAttention(nn.Module):
    ...
    def __init__(
        ...
        self.q = BitLinear(in_dim, in_dim, bias=False)
        self.k = BitLinear(in_dim, in_dim, bias=False)
        self.v = BitLinear(in_dim, in_dim, bias=False)
        self.out = BitLinear(in_dim, in_dim)
